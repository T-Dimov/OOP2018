...
{
public:
	RegularShape(const string &name_, size_t sideLenght = 1) : name(name_)
	{
...
{
public:
	Rectangle(const string &name_, size_t sideLenght = 1) :ex2(), RegularShape(name_, sideLenght)
	{
...
{
public:
	Square(const string &name_, size_t sideLenght = 1) : Rectangle(name_, sideLenght)
	{
		cout << "Square::Square()\n";
	}
...
{
public:
	Triangle(const string &name_, size_t sideLenght = 1) : RegularShape(name_, sideLenght)
	{
